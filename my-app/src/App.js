...
function App() {
  ...
  return (
    <div className="App">
      ...
      {/* условная отрисовка */}
      {/* проверяем длину массива постов с помощью тернарного оператора, */}
      {/* если она равна нулю, то выводим сообщение "Посты не найдены" */}
      {/* если она не равна нулю, то выводим постЛист */}
      {posts.length !== 0 
      ? 
